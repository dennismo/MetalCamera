...
//  MetalCamera
//
//  Created by Dennis on 2020/06/06.
//

import Foundation

public class Hue: OperationChain {
    ...
    private func setupPiplineState(_ colorPixelFormat: MTLPixelFormat = .bgra8Unorm) {
        do {
            let rpd = try sharedMetalRenderingDevice.generateRenderPipelineDescriptor("vertex_render_target", "hueFragment", colorPixelFormat)
